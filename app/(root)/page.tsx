...
export const metadata: Metadata = {
  ...
  description:
    "Rafi Achmad Fachrudi - Mobile App Developer specializing in Flutter and Kotlin (Android Native). Explore my projects, experience, and contributions.",
  alternates: {
          ...
          <div className="flex flex-col mt-4 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            ...
            <AnimatedText delay={0.8}>
              <Link
                ...
                aria-label="Contact Rafi Achmad Fachrudi"
              >
